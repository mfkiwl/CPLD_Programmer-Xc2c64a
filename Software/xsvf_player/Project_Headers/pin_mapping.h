...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   5: LLWU_P5              = PTB0 (A5/ACC_SCL)              */  { PortBInfo,  GPIOB_BasePtr,  0,       PORT_PCR_MUX(1)|defaultPcrValue  },
...
public:
   ...
   static void initPCRs(uint32_t pcrValue=defaultPcrValue) {
      ...
      enablePortClocks(PORTB_CLOCK_MASK);
#endif
      PORTB->GPCHR = pcrValue|PORT_PCR_MUX(3)|PORT_GPCHR_GPWE(0x0002UL);
   }
   ...
   static void clearPCRs() {
      ...
      enablePortClocks(PORTB_CLOCK_MASK);
#endif
      PORTB->GPCHR = PORT_PCR_MUX(0)|PORT_GPCHR_GPWE(0x2U);
   }
 ...
 *  PTB0                     | GPIOB_0/LLWU_P5                             | A5/ACC_SCL                | TMS       
 *  PTB1                     | GPIOB_1                                     | A4/ACC_SDA                | TDI       
 *  PTB2                     | GPIOB_2                                     | D15                       | TDO       
 *  PTB3                     | GPIOB_3                                     | D14                       | TCK       
 *  PTB16                    | -                                           | ConRx                     | USB Serial Rx       
 ...
 *  PTC1                     | ADC0_SE15/TSI0_CH14                         | A1                        | Vref       
